---
name: japanese-email
description: Writes professional Japanese business emails with correct keigo (honorifics), seasonal greetings (時候の挨拶), and proper structure. Handles teineigo, sonkeigo, and kenjogo appropriately. Use when writing emails to Japanese companies, clients, or colleagues.
---
...
- **[reference/email-templates.md](reference/email-templates.md)** - 12 complete templates for common scenarios
- **[reference/keigo-examples.md](reference/keigo-examples.md)** - Detailed honorific verb transformations
- **[reference/seasonal-greetings.md](reference/seasonal-greetings.md)** - 時候の挨拶 by month
...
4. **Starting without greeting**
   - ❌ 資料を送ります → ✅ お世話になっております。資料をお送りいたします。

5. **Too direct requests**
   - ❌ 返事をください → ✅ ご返信いただけますと幸いです

6. **Using casual language**
   - ❌ 了解です → ✅ 承知いたしました / かしこまりました

7. **Emojis in business emails** - Never use in formal correspondence

### Name/Title Errors

8. **Wrong honorific suffix**
   - ❌ 田中さん (too casual) → ✅ 田中様
...
- [Japanese Business Email Guide (Coto Academy)](https://cotoacademy.com/ultimate-guide-japanese-business-emails/)
- [Email Templates (TCJ)](https://tcj-education.com/blog/how-to-write-business-emails-to-clients-in-japanese-with-free-templates/)
- [Seasonal Greetings Guide (freee)](https://www.freee.co.jp/kb/kb-invoice/seasonal-greetings/)
- [ビジネスメール文例集 (business-mail.jp)](https://business-mail.jp/example)

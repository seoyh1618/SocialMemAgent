---
name: orchata-mcp
description: Use Orchata MCP tools to search, browse, and manage knowledge bases programmatically. For MCP-connected environments only.
metadata:
  version: 1.0.0
  author: Orchata AI
---
...
| Get space | `manage_space` | `manage_space with action="get" id="space_123"` |
| List documents | `list_documents` | `list_documents with spaceId="space_123"` |

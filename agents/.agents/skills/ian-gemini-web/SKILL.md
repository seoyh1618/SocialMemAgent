...
Generated PNG images automatically have Gemini watermarks removed using the [Reverse Alpha Blending algorithm](https://github.com/journey-ad/gemini-watermark-remover).

...
metadata: {"openclaw":{"emoji":"#️","requires":{"bins":["python3", "npm"]}}}
---
...
```bash
python3 skills/ui-ux/scripts/search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
python3 skills/ui-ux/scripts/search.py "animation accessibility" --domain ux

# Get alternative typography options if needed
python3 skills/ui-ux/scripts/search.py "elegant luxury serif" --domain typography
```

### Step 4: Stack Guidelines

```bash
python3 skills/ui-ux/scripts/search.py "layout responsive form" --stack html-tailwind
```
